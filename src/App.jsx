...
import { bestSellingTv } from './constants/inventory';
import { generateTvName, formatPrice, formatScreenSizes } from './helpers/helperFunctions.js';
...
function App() {
    ...
    return (
        <div>
            ...
            <p>{formatScreenSizes(bestSellingTv.availableSizes)}</p>
